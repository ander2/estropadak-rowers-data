...
class EteAgeParser:
    ...
    staff = [
        {'url': 'clubes/2018/29/1/hercos-colindres/plantilla', 'name': 'Colindres'},
        ...
        {'url': 'clubes/2018/250/1/hernani-iparragirre-sagardotegia-/plantilla', 'name': 'Hernani'},
        {'url': 'clubes/2018/6/1/hibaika-jamones-ancn-/plantilla', 'name': 'Hibaika'},
        {'url': 'clubes/2018/89/1/lea-artibai-cikautxo/plantilla', 'name': 'Lea-Artibai'},
        {'url': 'clubes/2018/100/1/kaiku-producha/plantilla', 'name': 'Kaiku'},
        {'url': 'clubes/2018/235/1/lapurdi-/plantilla', 'name': 'Lapurdi'},
        {'url': 'clubes/2018/22/1/tolosaldea-arraun-kluba/plantilla', 'name': 'Tolosaldea'}
    ]
